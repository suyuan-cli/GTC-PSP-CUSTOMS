  ...
  <div class="login-wrap">
    <div class="ms-login" v-loading="loading">
      ...
      >
        ...
        <p class="login-tips">Tips : 企业中心：企业账号/abc123456</p>
        <p class="login-tips">Tips : 监管用户：运维监管/abc123456</p>
        <p class="login-tips">Tips : 消费者：消费者账号/abc123456</p>
        <p class="login-tips">Tips : 服务商：运维服务商/abc123456</p>
      </el-form>
    </div>
  </div>
</template>
