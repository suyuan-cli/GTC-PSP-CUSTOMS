<template>
  <div class="time-line-item" :class="{ active: activity }">
    <slot name="label">
...
.active .time-line-item-label {
  color: #6ca3f8;
}

.active .time-line-item-avatar >>> .el-avatar {
  border-color: #6ca3f8;
}

.active .time-line-item-content {
  border-color: #6ca3f8;
}

.active .time-line-item-content:before {
  border-right-color: #6ca3f8;
}
