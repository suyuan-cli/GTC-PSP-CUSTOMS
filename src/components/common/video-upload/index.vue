<template>
  <div class="video-group videoplaycon">
    <slot name="title">
      <div class="video-group-title"></div>
    </slot>
    <div class="video-group-body" v-loading="uploading">
      <div tabindex="0" class="el-upload el-upload--picture-card" v-show="!previewImage">
      ...
      <div class="picture-item" v-show="previewImage">
        ...
        <i class="el-icon-caret-right" v-show="!showVideo" @click.stop="playVideo"></i>
        <i
          v-show="previewImage"
    ...
    <div v-if="showVideo" class="video-player-container" ref="videoPlayerContainer">
      <video-player
          ...
          FileUploaded(up, file, info) {
            ...
            if (info.status === 200) {
              ...
              if (response.status == 'success') {
                ...
                vm.$emit('unloaded', {
                  coverurl: vm.responseData.coverurl,
                  playaddress: vm.responseData.playaddress,
                });
